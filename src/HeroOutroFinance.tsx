/**
 * HeroOutroFinance — End-of-video outro, finance (paperOrange) variant.
 *
 * Fork of HeroOutro repinned to PALETTES.paperOrange: soft warm-white paper,
 * ink wordmark and copy, muted meta, burnt orange reserved for the orbiting
 * border glow + the CTA slash marker (the single accent). Shadows/vignette are
 * faint and warm — never heavy black, never white glow.
 *
...
// Light ground → depth is a faint warm vignette + soft warm card shadow,
// never heavy black.
const VIGNETTE = "radial-gradient(125% 125% at 50% 42%, transparent 62%, rgba(28,26,21,0.06) 100%)";
const CARD_SHADOW = "0 18px 48px -16px rgba(28,26,21,0.14), inset 0 0 0 1px rgba(255,255,255,0.5)";

const CHANNEL_NAME = "friction.";

export const HeroOutroFinancePropsSchema = z.object({
  ...
  bgColor:    z.string().optional().default(P.bg),
  accentColor: z.string().optional().default(P.accent),
  skipIntro:  z.boolean().optional().default(false),
  worldState: WorldStateSchema.optional(),
});
export type HeroOutroFinanceProps = z.infer<typeof HeroOutroFinancePropsSchema>;
    ...
    <div style={{
      ...
      <div style={{
        ...
        {src ? (
          ...
          /* Placeholder pattern when nothing loaded — warm geo panel */
          <div style={{
            width: "100%", height: "100%",
            background: `linear-gradient(135deg, ${P.bgGeo} 0%, ${P.bg} 100%)`,
...
// ── Component ─────────────────────────────────────────────────────────────────
export const HeroOutroFinance: React.FC<HeroOutroFinanceProps> = ({
  leadIn,
  subscribeAsk,
  videoLeftTitle,
  videoRightTitle,
  ...
  return (
    <AbsoluteFill>
      ...
      {/* Faint warm vignette for depth (light ground — never heavy black) */}
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Slash marker = the single burnt-orange accent in the copy block */}
